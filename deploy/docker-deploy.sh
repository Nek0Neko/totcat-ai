#!/bin/bash
# =============================================================================
# TotCat Docker Deployment Preparation Script
# =============================================================================
# This script prepares deployment files for TotCat:
...
GITHUB_RAW_URL="https://raw.githubusercontent.com/Nek0Neko/totcat-ai/main/deploy"
...
main() {
    echo ""
    echo "=========================================="
    echo "  TotCat Deployment Preparation"
    echo "=========================================="
    echo ""
    ...
    echo ""
    echo "  3. View logs:"
    echo "     docker-compose -f docker-compose.local.yml logs -f totcat"
    echo ""
